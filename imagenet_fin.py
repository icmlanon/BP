'''Script for finetuning with integer bitlengths for imagenet models'''
...
def main( gpu:Param("GPU to run on", str)=None ):
    ...
    #tot_epochs,size,bs,lr =35,224,128,0.001
    #tot_epochs,size,bs,lr =90,224,128,0.01
    tot_epochs,size,bs,lr =15,224,128,0.01
    ...
    '''Load non-int bitlength trained model:'''
    learn.load('/home/datasets/ILSVRC2012_full/trained_models/alex_10')




    #learn.load('/home/datasets/ILSVRC2012_full/models/fix_29')
    learn.load('/home/datasets/ILSVRC2012_full/trained_models/alex_10')
    #learn.load('/home/datasets/ILSVRC2012_full/trained_models/mobilev2_10')
    #learn.load('/home/datasets/ILSVRC2012_full/trained_models/res_10')


    '''Fix integer bitlengths:'''
    ...
    #learn.loss_func = Quant_Loss(model, 0.01)
